  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.userPicContainer}>
        ...
        />
        <Text style={styles.header}> Jordan Taylor</Text>
      </View>
      ...
      <View style={styles.userInfo}>
        <View style={styles.userDetails}>
          <FontAwesome
            ...
            color={Themes.colors.darkShade}
          />
          <Text style={styles.paragraph}>Birthday: June 12, 2001 </Text>
        </View>
        <View style={styles.userDetails}>
          <FontAwesome5
            ...
            color={Themes.colors.darkShade}
          />
          <Text style={styles.paragraph}>Identity: Man </Text>
        </View>
        <View style={styles.userDetails}>
          <Ionicons
            name="location-sharp"
            ...
            color={Themes.colors.darkShade}
          />
          <Text style={styles.paragraph}>Distance: 4 miles away</Text>
        </View>
        <View style={styles.userDetails}>
          <FontAwesome name="heart" size={24} color={Themes.colors.darkShade} />
          <Text style={styles.paragraph}>Interests: Gaming, Cooking</Text>
        </View>
      </View>
      ...
      <View style={styles.aboutMeContainer}>
        <Text style={styles.paragraph}>
          With a keen enthusiasm for virtual gaming, I often explore immersive
          digital realms as a way to unwind and connect with online friends.
          Beyond the virtual world, I'm also an avid culinary adventurer!{" "}
        </Text>
      </View>

      <Link href="/jordanChat" asChild>
        <Pressable>
          <View style={styles.messageBox}>
            <Ionicons
              ...
              color={Themes.colors.darkShade}
            />
            <Text style={styles.linkText}>Chat with Jordan!</Text>
          </View>
        </Pressable>
      </Link>
    </SafeAreaView>
